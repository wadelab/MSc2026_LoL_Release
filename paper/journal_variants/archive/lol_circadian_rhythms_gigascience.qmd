...
abstract: |
  ...
  release the full analysis code and de-identified derived outputs underlying all
  figures and summary statistics, and we discuss interpretation limits and data-
  sharing constraints for public match telemetry.
keywords:
  - circadian rhythms
  - chronotype
...
with `quarto render paper/journal_variants/lol_circadian_rhythms_gigascience.qmd`.
